...
// neeed to set up toString so that it actualy displays filling status(done)
// clean up any extra or redundent code
// bug test
// add a while loop
// make it so that agi is [gross income - (deductions + withholding)], then take agi through brackets and subtract tax credits.
